...
let s:palette.foreground=[1,'#808080']
let s:palette.highlight=[ 2,'#5f5faf']
let s:palette.accent1=[   3,'#005faf']
let s:palette.accent2=[   4,'#005fff']
let s:palette.text01=[    5,'#8a8a8a']
let s:palette.text02=[    6,'#949494']
let s:palette.text03=[    7,'#9e9e9e']
let s:palette.text04=[    8,'#a8a8a8']
let s:palette.text05=[   10,'#b2b2b2']
let s:palette.text06=[   11,'#bcbcbc']
let s:palette.text07=[   13,'#c6c6c6']
let s:palette.green=[     9,'#00d7af']
let s:palette.red=[      14,'#8700ff']
let s:palette.blue=[     12,'#0000d7']
