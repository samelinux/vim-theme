...
let s:palette.foreground=[1,'#FF90BC']
let s:palette.highlight=[ 2,'#FF90BC']
let s:palette.accent1=[   3,'#EFE9AF']
let s:palette.accent2=[   4,'#9FACDF']
...
call s:hi('CursorLine',s:palette.text01,s:palette.highlight,'none')
call s:hi('CursorLineNr',s:palette.highlight,s:palette.text01,'none')

call s:hi('Visual',s:palette.text01,s:palette.accent2,'')
